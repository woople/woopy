...
describe Woopy::Account do
  ...
  before do
    ...
    ActiveResource::HttpMock.respond_to do |mock|
      ...
      mock.get(    '/services/v1/accounts/1/user_employments/1.json', accept_request_headers(@token), user_employment_response )
  ...
  context "with an existing user" do
    ...
    describe "#find_employment" do
      ...
      it { should be_kind_of Woopy::UserEmployment }
